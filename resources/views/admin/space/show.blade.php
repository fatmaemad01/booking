<x-main-layout title="Space">
    ...
    <div class="row align-items-center">
        ...
        <div class="col-7">
            ...
            <x-bg-modal btn="Booking Now" class="modal-dialog-centered modal-dialog-scrollable modal-dialog modal-xl" id="create">
                                        ...
                                        <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton2">
                                            ...
                                            <li class="dropdown-item">
                                                <div class="form-check">
                                                    <input class="form-check-input" name="days[]" type="checkbox" value="{{$day->id}}" id="day-{{$day->id}}" >
